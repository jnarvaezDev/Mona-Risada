    ...
    <div className="relative min-h-screen">
      ...
      <footer className="container py-8 text-center text-xs text-white/55">
        ...
        <p className="mx-auto mt-4 max-w-5xl text-left text-[11px] leading-5 text-white/70 md:text-center md:text-xs md:leading-6">
          *Al inscribirte, autorizas que tus datos sean tratados exclusivamente para gestionar tu participación en la actividad promocional de fidelización del tema musical "Mona Rizada" (el 4 de junio de 2026 en Cali). El acceso a la invitación se asignará mediante una dinámica de selección digital por ranking en vivo, válida únicamente para mayores de edad residentes en Colombia que cuenten con un perfil público en la instagram. El beneficio consiste única y exclusivamente en la entrada al evento de lanzamiento en la ciudad de Cali. Este acceso no incluye tiquetes, transporte, hospedaje, viáticos ni alimentación; por lo tanto, si resides en cualquier otra ciudad, deberás asumir la totalidad de los costos de traslado por tu cuenta y riesgo así mismo cualquier consumo no incluido en el evento también debe correr por la cuenta de la persona. Esta dinámica no constituye un juego de suerte y azar ni sorteo, sino una actividad de agilidad por ranking y cumplimiento de requisitos con límite de tiempo. El organizador se exime de cualquier responsabilidad por la imposibilidad del participante seleccionado para asistir al lugar del evento.
        </p>
      </footer>
    </div>
  );
